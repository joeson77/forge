    ...
    <![endif]-->
								...
								<div class="shopping-cart">
									...
									<ul class="shopping-cart-down box-shadow white-bg">
										...
										<li class="media">
											...
											<a class="cart-btn" href="shoppingcarts.html">CHECKOUT</a>
										</li>
									</ul>
								</div>
							</div>
								...
								<div class="registered-customers">
									...
									<form action="#">
										<div class="login-account p-30 box-shadow">
											...
											<input type="text" placeholder="Username/Email Address" name="name">
											<input type="password" placeholder="Password" name="password">
											<input type="text" id="code_text" placeholder="Input the Checkcode" onfocus="createCode()">
											<input type="button" id="checkCode_get" onclick="createCode()">
											<a onclick="createCode()">Unclear?</a>
											<input id="login_buttom" onclick="validate();" type="button" value="Login">
		...
		<script>
			...
			function createCode() {
				...
				var checkCode = document.getElementById("checkCode_get");
				checkCode.value = "";
			...
			function validate() {
				var inputCode = document.getElementById("code_text").value.toUpperCase();

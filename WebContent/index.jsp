		...
		$("#logintwo").click(
				function() {
					$.get("LoginTwoServlet", {
						...
						var ret = result.substring(0, 4);
						var uname = result.substring(4, result.length);
						if (ret == "true") {
							$("#loginname").css("font-size", "15px").html(
									"<a id='my-account' href='my-account.jsp'>"
											+ "欢迎您" + " " + uname + "</a>");
						...
						<div class="col-sm-5 hidden-xs">
							<div class="header-top-left">
								<ul class="header-top-style text-capitalize mr-25">
									<li><a href="#"><span class="mr-10">My Account</span><i
								...
								<ul class="header-top-style">
									<li><a> <c:choose>
												<c:when test="${!empty(sessionScope.customer)}">
													<!-- 登录 -->
													<span><a href="my-account.jsp"
														style="font-size: 15px">欢迎用户:&nbsp;<%=session.getAttribute("customer")%></a></span>
													<script>
														$(function() {
															$("#loginDiv").css(
																	"display",
										...
										<div id="loginDiv"
											class="ul-style login-register box-shadow white-bg p-30">
											<!-- <form action="LoginTwoServlet" method="post"> -->
											<h6 class="mb-20">
												<strong>Login</strong>
											</h6>
											<input type="text" name="s" class="pl-30"
												placeholder="user name" id="user-name"> <label
												id="SB" style="display: none;">该用户不存在，请先<a
												class="mb-20" href="login.jsp" style="font-size: 15px">注册</a>!
											</label> <input type="password" name="d" class="pl-30"
												placeholder="Password" id="password"> <label
												class="remmember"> <input type="checkbox">
												remember me
											</label>
											<button id="logintwo" class="btn-default">Login</button>
											<a href="login.jsp"><h6>
					...
					<div class="row header-middle-content">
						...
						<div
							...
							<div class="shopping-cart">
								...
								</span> <a href="shoppingcarts.html"><span class="cart-size-value"><strong>Shopping<br>Carts(3)
										</strong></span></a>
								</a>
									...
									<li class="media"><a href="#"><img alt=""
										...
										<div class="cart-item-wrapper">
											<a href="#">Zelletria ostma</a> <span class="quantity">
												<span class="amount">$195</span> x 2
											</span> <a title="Remove this item" class="remove" href="#"> <i
									...
									<li class="media"><a href="#"><img alt=""
										...
										<div class="cart-item-wrapper">
											<a href="#">Letria postma</a> <span class="quantity">
												<span class="amount">$145</span> x 1
											</span> <a title="Remove this item" class="remove" href="#"> <i
												class="fa fa-trash-o"></i>
											</a>
										</div></li>
									<li class="media"><a href="#"><img alt=""
										...
										<div class="cart-item-wrapper">
											<a href="#">Montria jastma</a> <span class="quantity">
												<span class="amount">$155</span> x 2
											</span> <a title="Remove this item" class="remove" href="#"> <i
												class="fa fa-trash-o"></i>
											</a>
										</div></li>
									<li class="media"><span class="total-title pull-left">Sub
											Total</span> <span class="total pull-right">$845</span></li>
									<li class="media"><a class="cart-btn"
										href="shoppingcarts.jsp">VIEW CART</a> <a class="cart-btn"
										href="shoppingcarts.jsp">CHECKOUT</a></li>
								</ul>
							</div>
						</div>
		...
		<section class="slider-container">
			...
			<div id="mainSlider" class="nivoSlider slider-image">
				<img src="images/slider/1.jpg" alt="main slider"
					title="#htmlcaption1"> <img src="images/slider/2.jpg"
						...
						<div class="col-xs-offset-5 col-xs-7 slider-height">
							<div class="slide-text">
								<div class="middle-text">
									...
									<div class="cap-shop wow fadeInDown" data-wow-duration="2.5s"
										data-wow-delay="1.5s">
										<a href="#">Shop now</a>
									</div>
								</div>
		...
		<section id="page-content" class="page-wrapper">
					...
					<div class="row">
						<div class="col-md-3 col-sm-4">
							<div class="why-us-inner">
								...
								<h5 class="text-uppercase m-0 text-defualt">
					...
					<div class="row rp-style">
						<div class="col-sm-4 cp-style">
							<div class="banner-inner">
								...
								<div class="banner-text banner-text-1">
									<a href="#" class="banner-heading text-uppercase text-right">new
										trend for women's</a>
									<h3 class="banner-title text-uppercase text-right">special
										offer 25% off</h3>
								</div>
							</div>
						</div>
						<div class="col-sm-8 cp-style">
							<div class="row rp-style">
								<div class="col-sm-8 cp-style">
									<div class="banner-inner">
										<a class="test-popup-link banner-img"
											href="images/banner/2.jpg"> <img
											src="images/banner/2.jpg" alt="">
										</a>
								...
								<div class="col-sm-4 cp-style">
									<div class="banner-inner">
										<a class="test-popup-link banner-img"
											href="images/banner/3.jpg"> <img
											src="images/banner/3.jpg" alt="">
										</a>
										<div class="banner-text banner-text-3">
											<a href="#" class="banner-heading text-uppercase text-right">shoes</a>
											<h3 class="banner-title text-uppercase text-right">35%
												off</h3>
										</div>
									</div>
								</div>
							...
							<div class="row rp-style mt-8">
								<div class="col-sm-4 cp-style">
									<div class="banner-inner">
										<a class="test-popup-link banner-img"
											href="images/banner/4.jpg"> <img
											src="images/banner/4.jpg" alt="">
										</a>
						...
						<div class="featured-carousel indicator-style">
							...
							<div class="product-container cp-style-2">
								<div class="product-inner">
									...
									</a> <span class="product-tag text-uppercase theme-bg">sale</span>
									<ul class="quick-veiw text-center">
										<li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
										<li><a href="#"><i class="fa fa-eye"></i></a></li>
										<li><a href="#"><i class="fa fa-refresh"></i></a></li>
							...
							<div class="product-container cp-style-2">
								<div class="product-inner">
									...
									</a> <span class="product-tag text-uppercase orang-bg">-20%</span>
									<ul class="quick-veiw text-center">
										<li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
										<li><a href="#"><i class="fa fa-eye"></i></a></li>
										<li><a href="#"><i class="fa fa-refresh"></i></a></li>
							...
							<div class="product-container cp-style-2">
								<div class="product-inner">
									...
									</a> <span class="product-tag text-uppercase orang-bg">-25%</span>
									<ul class="quick-veiw text-center">
										<li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
										<li><a href="#"><i class="fa fa-eye"></i></a></li>
										<li><a href="#"><i class="fa fa-refresh"></i></a></li>
			...
			<div class="offer-area">
				<div class="offer-banner banner-style-1 pull-left">
					...
					<div class="offer-banner-text text-uppercase text-white">
						<h2>coats</h2>
						<h3>
							FOR <span class="text-defualt"> MEN</span>
						</h3>
					</div>
				</div>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-up-comming ash-bg">
								...
								<div class="product-text white-bg pt-15">
									...
									<h6 class="product-name">
										<a href="#" title="Restalomen Santiloma">Restalomen
											Santiloma</a>
									</h6>
								</div>
							</div>
						...
						<div class="col-md-4 hidden-sm">
							<div class="single-up-comming ash-bg m-0">
								...
								<div class="product-text white-bg pt-15">
									...
									<h6 class="product-name">
										<a href="#" title="Eletriaostma Santiloma">Eletriaostma
											Santiloma</a>
									</h6>
								</div>
							</div>
				...
				<div class="container">
					<div class="row rp-style-2">
						<div class="col-md-12">
							<div class="section-title text-center mb-35">
								<h2 class="text-uppercase">
									<strong>FRESH NEW ARRIVAL</strong>
								</h2>
			...
			<div class="offer-banner-area section-padding clearfix">
				<figure class="single-offer-banner b-img">
					...
					<figcaption>
						<div
							class="figcation-text left-top text-uppercase text-left text-white">
							<h1>new</h1>
							<h1>Arrival</h1>
							<h1>20% off</h1>
						</div>
				...
				<figure class="single-offer-banner b-img">
					...
					<figcaption>
						...
						<div
							class="figcation-text text-uppercase right-bottom text-white text-right">
							<h1>EXCLUSIVE</h1>
							<h1>COLLECTIONS</h1>
						</div>
					</figcaption>
				...
				<figure class="single-offer-banner b-img m-0">
					...
					<figcaption>
						<div
							class="figcation-text right-top text-uppercase text-left text-white text-right">
							<h1>BIG OFFER</h1>
							<h1>35% OFF</h1>
						</div>
							...
							<div class="best-seller-carousel indicator-style-two">
									...
									<div class="best-product-inner mb-35 row rp-style-3 clearfix">
										<div class="col-xs-5 cp-style-3">
											<div class="best-product-img b-img b-img">
												<a href="#"> <img src="images/best-seller/2.jpg" alt="">
												</a>
											</div>
										</div>
									...
									<div class="best-product-inner row rp-style-3 clearfix">
										<div class="col-xs-5 cp-style-3">
											<div class="best-product-img b-img">
												<a href="#"> <img src="images/best-seller/3.jpg" alt="">
												</a>
											</div>
										</div>
										<div class="col-xs-7 cp-style-3">
								...
								<div class="product-container">
									<div class="best-product-inner mb-35 row rp-style-3 clearfix">
										<div class="col-xs-5 cp-style-3">
											<div class="best-product-img b-img">
												<a href="#"> <img src="images/best-seller/4.jpg" alt="">
												</a>
											</div>
										</div>
										<div class="col-xs-7 cp-style-3">
									...
									<div class="best-product-inner row rp-style-3 clearfix">
										<div class="col-xs-5 cp-style-3">
											<div class="best-product-img b-img">
												<a href="#"> <img src="images/best-seller/1.jpg" alt="">
												</a>
											</div>
										</div>
										<div class="col-xs-7 cp-style-3">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							<div class="section-title text-center mb-35">
								<h2 class="text-uppercase">
									<strong>NEWS FROM THE BLOG</strong>
								</h2>
							...
							<div class="blog-carousel indicator-style-two">
								<div class="single-blog blog-bg">
									<div class="blog-img b-img">
										<a href=""> <img alt="" src="images/blog/1.jpg">
										</a>
									</div>
									<div class="blog-text p-20">
										...
										<p>Lorem ipsum dolor sit amet, sed do eiusmod tempor ncunt
											ut labore et dolore na...</p>
										<a class="btn-read-more text-uppercase text-defualt" href="">read
											mroe</a>
										<ul class="blog-list bottom">
											<li><a href="#"> <i class="fa fa-comments"></i> 12
													Comments
											</a></li>
											<li><a href="#" class="text-defualt"> <i
													class="fa fa-heart"></i> 50 Likes
											</a></li>
										</ul>
									</div>
								</div>
								<div class="single-blog blog-bg">
									<div class="blog-img b-img">
										<a href=""> <img alt="" src="images/blog/2.jpg">
										</a>
									</div>
									<div class="blog-text p-20">
										<h4 class="text-uppercase text-defualt">
								...
								<div class="testimonial-inner">
									<div class="single-testimonial blog-bg mb-20">
										<div class="testimonial-img">
											<a href="#"> <img src="images/client/1.png" alt="">
											</a>
										</div>
										<div class="testimonial-content">
											<h5 class="text-uppercase text-defualt">
												THOMAS ALBERT,<span>Head of Ideas</span>
											</h5>
											<p class="m-0">Lorem ipsum dolor s it amet, otetur
												adipiscing elitamxercon</p>
										</div>
									</div>
									<div class="single-testimonial blog-bg">
										<div class="testimonial-img">
											<a href="#"> <img src="images/client/2.png" alt="">
											</a>
										</div>
										<div class="testimonial-content">
											<h5 class="text-uppercase text-defualt">
